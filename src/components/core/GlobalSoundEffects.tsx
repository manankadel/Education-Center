...
export const GlobalSoundEffects = () => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined') {
        clickSoundRef.current = new Audio('https://cdn.jsdelivr.net/gh/manankadel/swambasic@main/public/audio/typing.wav');
      clickSoundRef.current.volume = 0.5;

      typingSoundRef.current = new Audio('https://cdn.jsdelivr.net/gh/manankadel/swambasic@main/public/audio/typing.wav');
